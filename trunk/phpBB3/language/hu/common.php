...
$lang = array_merge($lang, array(
	...
	'AJAX_ERROR_TEXT_TIMEOUT'		=> 'A kérésed idő túllépés miatt megszakadt; kérjük próbáld újra.', //bb31
	...
	'CONFIRM_AVATAR_DELETE' => 'Biztosan törölni szeretnéd ezt az avatart?', //bb31
	...
	'INVALID_PLURAL_RULE'		=> 'A megadott többes szám azonosító érvénytelen. Csak egész szám lehet 0 és 15 között.', //bb31
	'IP'						=> 'IP-cím',
	...
	'JUMP_TO_PAGE_CLICK'	=> 'Kattints a megadott oldalra ugráshoz…', //bb31
	...
	'LEGEND'							=> 'Magyarázat',
	'LIVE_SEARCHES_NOT_ALLOWED'			=> 'Az élő keresések nincsenek engedélyezve.', //bb31
	...
	'LOGIN_REQUIRED'					=> 'Ehhez a művelethez be kell jelentkezned.', //bb31
	'LOGOUT'							=> 'Kilépés',
	...
	'NEVER'						=> 'Soha',
	'NO'						=> 'Nem',
	'NO_NOTIFICATIONS'			=> 'Nincs értesítésed', //bb31
	...
	'NOTIFICATION_BOOKMARK'				=> array(
		1	=> '<strong>Válasz</strong> %1$s-tól egy kedvencnek jelölt témában:', //bb31
	),
	'NOTIFICATION_FORUM'				=> '<em>Fórum:</em> %1$s', //bb31
	'NOTIFICATION_GROUP_REQUEST'		=> '<strong>Csatlakozási kérelem</strong> %1$s-tól, hogy csatlakozhasson a %2$s csoporthoz.', //bb31
	'NOTIFICATION_GROUP_REQUEST_APPROVED'	=> '<strong>Kérelem elfogadása</strong>, hogy csatlakozhass a %1$s csoporthoz.', //bb31 ?
	'NOTIFICATION_PM'					=> '<strong>Privát üzenet</strong> %1$s-tól', //bb31
	'NOTIFICATION_POST'					=> array(
		1	=> '<strong>Válasz</strong> %1$s-tól a témában:', //bb31
	),
	'NOTIFICATION_POST_APPROVED'		=> '<strong>Hozzászólás elfogadva</strong>:', //bb31
	'NOTIFICATION_POST_DISAPPROVED'		=> '<strong>Hozzászólás elutasítva</strong>:', //bb31
	'NOTIFICATION_POST_IN_QUEUE'		=> '<strong>Hozzászólás elfogadási kérés</strong> %1$s-tól:', //bb31
	'NOTIFICATION_QUOTE'				=> array(
		1	=> '<strong>Idézett</strong> %1$s:', //bb31 ?
	),
	'NOTIFICATION_REFERENCE'			=> '"%1$s"', //bb31
	'NOTIFICATION_REASON'				=> '<em>Indoklás:</em> %1$s.', //bb31
	'NOTIFICATION_REPORT_PM'			=> '%1$s <strong>jelentette a privát üzenetet</strong>:', //bb31 ?
	'NOTIFICATION_REPORT_POST'			=> '%1$s <strong>jelentette a hozzászólást</strong>', //bb31 ?
	'NOTIFICATION_REPORT_CLOSED'		=> '%1$s <strong>lezárta a jelentést</strong>:', //bb31
	'NOTIFICATION_TOPIC'				=> '%1$s <strong>létrehozott egy új témát</strong>:', //bb31
	'NOTIFICATION_TOPIC_APPROVED'		=> '<strong>Téma elfogadása</strong>:', //bb31
	...
	'POST_DISPLAY'			=> '%1$sHozzászólás megjelenítése%2$s.', //bb31
	'POST_DAY'				=> 'Naponta %.2f hozzászólás',
	'POST_DELETED_ACTION'	=> 'Törölt hozzászólás:', //bb31
	'POST_DELETED'			=> 'A hozzászólás törlésre került.', //bb31 ? Ez a hozzászólás?
	'POST_DELETED_BY'		=> '<strong>%2$s</strong> törölte <strong>%1$s</strong> hozzászólását %3$s-kor.', //bb31
	'POST_DELETED_BY_REASON'=> '<strong>%2$s</strong> törölte <strong>%1$s</strong> hozzászólását %3$s-kor a következő indokkal: %4$s', //bb31
	...
	'POST_UNAPPROVED_ACTION'		=> 'A hozzászólás jóváhagyásra vár:', //bb31 eredeti: 'This post is waiting for approval' - 'A hozzászólás jóváhagyásra vár',
	'POST_UNAPPROVED'		=> 'A hozzászólás még nem került jóváhagyásra.', //bb31
	'POSTS_UNAPPROVED_FORUM'=> 'Ebben a fórumban még legalább egy hozzászólás nem került jóváhagyásra.', //bb31 ? szórend
	...
	'SECONDS'					=> 'másodperc',
	'SEE_ALL'					=> 'Mindegyik megtekintése', //bb31 ? See All
	'SELECT'					=> 'Kiválasztás',
	...
	'STRING_LIST_MULTI'			=> '%1$s és %2$s', //bb31 Oxford comma %1$s, and %2$s
	'STRING_LIST_SIMPLE'		=> '%1$s és %2$s', //bb31
	'SUBFORUM'					=> 'Alfórum',
	'SUBFORUMS'					=> 'Alfórumok',
	'SUBJECT'					=> 'Téma',
	'SUBMIT'					=> 'Elküld',
	...
	'TIB'				=> 'TiB',
	'TIME'				=> 'Idő',
	'TIMEOUT_PROCESSING_REQ'			=> 'A kérés időtúllépés miatt nem teljesült.', //bb31 ? teljesíthető
	...
	'TOO_SHORT_EMAIL_CONFIRM'		=> 'A megadott e-mail cím megerősítés túl rövid.', //bb31 ?
	...
	'TOPIC_POLL'		=> 'A téma szavazást tartalmaz.', //bb31
	...
	'UNABLE_GET_IMAGE_SIZE'	=> 'Nem sikerült meghatározni a kép méretét. Kérjük ellenőrizd, hogy a megadott URL érvényes-e.', //bb31
	...
	'VIEWED'					=> 'Megtekintve',
	'VIEWED_COUNTS'		=> array(
		0	=> 'Még nem tekintették meg', //bb31 ?

...
$lang = array_merge($lang, array(
	...
	'REPORT_MESSAGE_EXPLAIN'	=> 'Ennek az űrlapnak a segítségével a kiválasztott üzenetet jelentheti. A jelentés csak arra az esetre való, ha az üzenet megszegi a fórum szabályait.', //? "Use this form to report the selected message to the board administrators. Reporting should generally be used only if the message breaks forum ruless." 'Csak akkor jelents...'?
	...
	'report_reasons'		=> array(
		...
		'DESCRIPTION' => array(
			...
			'OTHER'		=> 'A hozzászólás nem tartozik semelyik másik kategóriába, kérjük, töltse ki a további információ mezőt.' //? idézőjelek a további információ köré (+ esetleg további információk)?
		)
	),
));

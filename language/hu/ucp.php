...
$lang = array_merge($lang, array(
	...
	'PASSWORD_UPDATED_IF_EXISTED'	=> 'Ha a felhasználód létezik, az új jelszavad elküldésre került az e-mail címedre. Ha nem kapod meg az e-mailt, annak oka lehet, hogy a felhasználód tiltva van, nincs aktiválva vagy nincs jogod a jelszavad megváltoztatására. Ezekben az esetekben vedd fel a kapcsolatot a fórum adminisztrátorával. Valamint ellenőrizd, hogy az e-mail nem került-e a levélszemétbe.', //? If your account exists, a new password was sent to your registered email address. If you do not receive an email, it may be because you are banned, your account is not activated, or you are not allowed to change your password. Contact admin if any of those reasons apply. Also, check your spam filter.

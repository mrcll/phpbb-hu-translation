...
$lang = array_merge($lang, array(
	...
	'UPDATE_INCOMPLETE'				=> 'A phpBB telepítése nem lett megfelelően frissítve.',
	'UPDATE_INCOMPLETE_MORE'		=> 'Kérjük, olvassa el a lent található információkat a hiba javításához.',
	'UPDATE_INCOMPLETE_EXPLAIN'		=> '<h1>Hiányos frissítés</h1>

		<p>Észleltük, hogy a phpBB legutóbbi frissítése nem fejeződött be. Nyissa meg az <a href="%1$s" title="%1$s">adatbázis frissítőt</a>, bizonyosodjon meg róla, hogy <em>Az adatbázis frissítése</em> van kiválasztva és kattintson az <strong>Elküld</strong> gombra. Ne felejtse el törölni az "install" könyvtárat az adatbázis frissítésének befejezése után.</p>',

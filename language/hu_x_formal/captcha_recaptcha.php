...
$lang = array_merge($lang, [
	...
	'RECAPTCHA_V3_PUBLIC_EXPLAIN'	=> 'Az oldala reCAPTCHA kulcsa. Kulcs a <a href="http://www.google.com/recaptcha">www.google.com/recaptcha</a> oldalon kérhető. Kérjük, a reCAPTCHA v3 változatát használja.',
	'RECAPTCHA_PRIVATE'				=> 'Titkos kulcs',
	'RECAPTCHA_PRIVATE_EXPLAIN'		=> 'Az oldala titkos reCAPTCHA kulcsa. Kulcs a <a href="http://www.google.com/recaptcha">www.google.com/recaptcha</a> oldalon kérhető. Kérjük, a reCAPTCHA v2 &gt; Invisible reCAPTCHA badge típust használja.',
	'RECAPTCHA_V3_PRIVATE_EXPLAIN'	=> 'Az oldala titkos reCAPTCHA kulcsa. Kulcs a <a href="http://www.google.com/recaptcha">www.google.com/recaptcha</a> oldalon kérhető. Kérjük, a reCAPTCHA v3 változatát használja.',

	'RECAPTCHA_V3_DOMAIN'				=> 'Kérés domainnév', //? Request domain
	'RECAPTCHA_V3_DOMAIN_EXPLAIN'		=> 'A domainnév, amit a reCAPTCHA script betöltéséhez és a kérés ellenőrzéséhez használ.<br>Használja a <samp>recaptcha.net</samp> címet, ha a <samp>google.com</samp> nem elérhető.', //? The domain to fetch the script from and to use when verifying the request.<br>Use <samp>recaptcha.net</samp> when <samp>google.com</samp> is not accessible.
	...
	'EMPTY_RECAPTCHA_V3_REQUEST_METHOD'			=> 'A reCAPTCHA v3-nak tudnia kell, hogy melyik elérhető módon szeretné ellenőrizni a kérést.', //? reCAPTCHA v3 requires to know which available method you want to use when verifying the request.
]);

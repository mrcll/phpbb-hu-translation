...
$lang = array_merge($lang, array(
	...
	'AVATAR_DRIVER_GRAVATAR_EXPLAIN'=> 'A Gravatar szolgáltatás segítségével ugyanazt az avatart használhatod a Gravatart támogató összes oldalon. További információkat a <a href="http://www.gravatar.com/">Gravatar</a> weboldalán találsz.', //bb31
	'AVATAR_DRIVER_LOCAL_TITLE'		=> 'Avatar galéria', //bb31
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> 'Kiválaszthatod avatarodat egy helyi galériából.', //bb31
	...
	'AVATAR_DRIVER_UPLOAD_EXPLAIN'	=> 'Saját avatar képed feltöltése számítógépről.', //bb31
	...
	'AVATAR_PAGE'					=> 'Oldal', //?
	'AVATAR_SELECT'					=> 'Válaszd ki avatarod', //bb31
	...
	'FIELD_INVALID_CHARS_LETTER_NUM_DOTS'	=> 'A “%s” mező érvénytelen karaktereket tartalmaz, csak betűk, számok és . jelek használata engedélyezett.', //bb31
	'FIELD_INVALID_CHARS_LETTER_NUM_ONLY'	=> 'A “%s” mező érvénytelen karaktereket tartalmaz, csak betűk és számok használata engedélyezett.', //bb31
	'FIELD_INVALID_CHARS_LETTER_NUM_PUNCTUATION'	=> 'A “%s” mező érvénytelen karaktereket tartalmaz, csak betűk, számok és _,-. jelek használata engedélyezett, valamint az első karakternek betűnek kell lennie.', //bb31
	'FIELD_INVALID_CHARS_LETTER_NUM_SPACERS'		=> 'A “%s” mező érvénytelen karaktereket tartalmaz, csak betűk, számok, szóköz és -+_[] jelek használata engedélyezett.', //bb31
	'FIELD_INVALID_CHARS_LETTER_NUM_UNDERSCORE'		=> 'A “%s” mező érvénytelen karaktereket tartalmaz, csak betűk, számok és _ jel használata engedélyezett.', //bb31
	...
	'GRAVATAR_AVATAR_EMAIL_EXPLAIN'	=> 'Add meg a <a href="http://www.gravatar.com/">Gravatar</a> szolgáltatás regisztrációjánál használt e-mail címed.', //bb31
	'GRAVATAR_AVATAR_SIZE'			=> 'Avatar méretei', //bb31
	'GRAVATAR_AVATAR_SIZE_EXPLAIN'	=> 'Add meg az avatar kép méreteit, vagy hagyd üresen az automatikus megállapításhoz.', //bb31 ? automatic verification
	...
	'LOGIN_LINK'					=> 'Kösd össze vagy regisztráld külső felhasználói azonosítódat a fórum felhasználói azonosítóddal', //bb31
	'LOGIN_LINK_EXPLAIN'			=> 'Egy olyan külső szolgáltatás használatával próbáltál meg bejelentkezni, ami még nincs hozákapcsolva a fórumbeli felhasználói azonosítódhoz. Hozzá kell kapcsolnod egy már létezőhöz vagy újat kell regisztrálnod.', //bb31
	'LOGIN_LINK_MISSING_DATA'		=> 'Nem érhetőek el azok az adatok, amik szükségesek a felhasználói azonosítód és a külső szolgáltatás összekapcsolásához. Kérjük, próbálj meg újra bejelentkezni.', //bb31 ? Restart the login process
	'LOGIN_LINK_NO_DATA_PROVIDED'	=> 'Nem kerültek átadásra azok az adatok, amik szükségesek a felhasználói azonosítód és a külső szolgáltatás összekapcsolásához. Kérjük, vedd fel a kapcsolatot egy adminisztrátorral, ha továbbra is problémát tapasztalsz.', //bb31 ? No data has been provided
	...
	'NOTIFICATIONS_MARK_ALL_READ_CONFIRM'				=> 'Valóban meg szeretnéd jelölni az összes értesítést olvasottként?', //bb31
	...
	'NOTIFICATION_TYPE_PM'								=> 'Valaki privát üzenetet küld neked', //bb31 ?
	'NOTIFICATION_TYPE_POST'							=> 'Valaki válaszol egy témában, amire feliratkoztál', //bb31 ?
	...
	'NO_AUTH_PROFILEINFO'			=> 'Nincs jogosultságod a profil adataid megváltoztatására.', //bb31
	...
	'PM_MARK_ALL_READ'			=> 'Minden üzenet megjelölése olvasottként', //bb31
	'PM_MARK_ALL_READ_SUCCESS'	=> 'A mappában minden privát üzenet olvasottként lett megjelölve', //bb31
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> 'Az "Emlékezz rám" kulcsok automatikusan bejelentkeztetnek, ha meglátogatod a fórum egyik oldalát. Kilépéskor a kulcs csak arról a számítógépről kerül törlésre, ahonnan kiléptél. Itt megnézheted azokat a kulcsokat, amiket a fórum más számítógépről történő megtekintéséhez használtál.', //bb31
	'PROFILE_NO_AUTOLOGIN_KEYS'	=> 'Nincs mentett "Emlékezz rám" kulcs.', //bb31
	...
	'UCP_AUTH_LINK_ASK'			=> 'Jelenleg nincs ezzel a külső szolgáltatással összekapcsolt felhasználói azonosítód. Kattints a lent található gombra, hogy összekapcsold a fórumbeli felhasználói azonosítód a külső szolgáltatás felhasználói azonosítójával.', //bb31
	...
	'UCP_PROFILE_AUTOLOGIN_KEYS'=> '“Emlékezz rám” kulcsok kezelése', //bb31

	'UCP_USERGROUPS'			=> 'Csoportok',
	'UCP_USERGROUPS_MEMBER'		=> 'Tagságok szerkesztése',
	'UCP_USERGROUPS_MANAGE'		=> 'Csoportok kezelése',

	'UCP_PASSWORD_RESET_DISABLED'	=> 'A jelszó visszaállítási funkció le lett tiltva. Ha segítségre van szükséged az azonosítód eléréséhez, vedd fel a kapcsolatot a %sfórum adminisztrátoraival%s', //bb31
	...
	'VIEW_PROFILE'				=> 'Profil megtekintése', //bb31

...
$lang = array_merge($lang, array(
	...
	'FULLTEXT_POSTGRES_TS_NAME'				=> 'Szöveg keresési profil:', //bb31 ? Text search Configuration Profile
	...
	'FULLTEXT_POSTGRES_TS_NAME_EXPLAIN'				=> 'A szöveg keresési profil határozza meg a kereséshez használandó elemzőt és szótárt.', //bb31
	...
	'FULLTEXT_SPHINX_CONFIGURE'				=> 'Add meg a következő értékeket a sphinx konfigurációs állomány generálásához', //bb31
	'FULLTEXT_SPHINX_DATA_PATH'				=> 'Adatok elérési útja', //bb31
	'FULLTEXT_SPHINX_DATA_PATH_EXPLAIN'		=> 'Ez a könyvtár lesz használva az index- és naplóállományok tárolásához. A könyvtárat webről el nem érhető helyen hozd létre. (Az elérési utat záró perjellel add meg.)', //bb31
	'FULLTEXT_SPHINX_DELTA_POSTS'			=> ' Hozzászólások száma a gyakran frissülő delta indexben', //bb31 ?
	'FULLTEXT_SPHINX_HOST'					=> 'Sphinx hosztneve', //bb31 ? Sphinx search daemon host
	'FULLTEXT_SPHINX_HOST_EXPLAIN'			=> 'A kiszolgáló, amin a Sphinx daemon fut. Hagyd üresen az alapértelmezett localhost használatához.', //bb31
	'FULLTEXT_SPHINX_INDEXER_MEM_LIMIT'		=> 'Indexelő memória limit', //bb31
	'FULLTEXT_SPHINX_INDEXER_MEM_LIMIT_EXPLAIN'	=> 'Az értékének mindig kisebbnek kell lennie, mint a kiszolgálóban található RAM mennyisége. Ha időszakos teljesítmény problémákat tapasztalsz, annak oka lehet az indexelő általi túlzott erőforrás-használat. Ilyenkor segíthet az indexelő számára használható memória mennyiségének csökkentése.', //bb31
	'FULLTEXT_SPHINX_MAIN_POSTS'			=> 'Hozzászólások száma a fő indexben', //bb31 ? main index
	'FULLTEXT_SPHINX_PORT'					=> 'Sphinx portja', //bb31
	'FULLTEXT_SPHINX_PORT_EXPLAIN'			=> 'Az a portszám, amin a sphinx search daemon (searchd) figyel. Hagyd üresen az alapértelmezett 9312 használatához.', //bb31

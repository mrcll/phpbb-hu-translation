...
$help = array(
	...
	array(
		...
		1 => 'Igen, természetesen lehet kombinálni a címkéket. Például, ha fel akarja hívni valakinek a figyelmét:<br /><br /><strong>[size=18][color=red][b]</strong>OLVASSA EL!<strong>[/b][/color][/size]</strong><br /><br />ezt eredményezi: <span style="color:red;font-size:18px;"><strong>OLVASSA EL!</strong></span><br /><br />Ennek ellenére nem ajánlott, hogy egyszerre sok formázási eszközt használjon, mivel ennek következtében a szöveg nehezen lesz olvasható. Kérjük, ügyeljen a címkék lezárásának sorrendjére. A következő példa hibás:<br /><br /><strong>[b][u]</strong>Ez így hibás!<strong>[/b][/u]</strong>'
	),
	array(
		0 => '--',
		1 => 'Idézés és kódok'

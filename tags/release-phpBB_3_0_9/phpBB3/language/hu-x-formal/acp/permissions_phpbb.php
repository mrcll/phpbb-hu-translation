...
*
* @package language
* @version $Id: permissions_phpbb.php 199 2009-10-19 20:24:38Z fberci $
...
$lang = array_merge($lang, array(
	'permission_cat'	=> array(
		...
		'user_group'	=> 'Felhasználók és csoportok', //? túl hosszú, itt már tényleg nem mindig fér ki
	),
...
$lang = array_merge($lang, array(
	...
	'acl_u_ignoreflood'	=> array('lang' => 'Figyelmen kívül hagyhatja a flood időközt', 'cat' => 'misc'), //? figyelmen kívül hagy - mellőz?
...
$lang = array_merge($lang, array(
	...
	'acl_f_email'		=> array('lang' => 'Küldhet értesítő e-mailt a témákról', 'cat' => 'actions'), //? "Can e-mail topics"
	...
	'acl_f_postcount'	=> array('lang' => 'Hozzászólásainak számának növelése<br /><em>Kérjük, vedd figyelembe, hogy ez csak az új hozzászólásokra van hatással.</em>', 'cat' => 'misc'), //? "Increment post counter"
...
// Admin Permissions
$lang = array_merge($lang, array(
	'acl_a_board'		=> array('lang' => 'Megváltoztathatja a fórum beállításokat, láthatja a frissítések keresését', 'cat' => 'settings'), //? "Can alter board settings/check for updates"
	...
	'acl_a_fauth'		=> array('lang' => 'Módosíthatja a fórum jogosultság osztályt', 'cat' => 'permissions'), //?? mit jelent?
